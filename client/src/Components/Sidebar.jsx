...
import {FaCubesStacked,FaUser,FaAddressCard,FaPowerOff,} from 'react-icons/fa6'
  ...
  return (
    <div className='sidebar'>
      ...
      onClick={()=>setActiveLink(2)}>
        ...
        <FaAddressCard className='icon' />Add Contact
        </Link>
      </div>
      <div className={`sidebar-item ${activeLink === 3 ? "active" : ""}`}
      onClick={()=>setActiveLink(3)}>
        <Link to='/logout'  className='sidebar-link'><FaPowerOff className='icon' /> Exit</Link>
      </div>
